...
function Join() {
  ...
  const sendJoinForm= (e) => {
      ...
      axios.post(`/join`, userDetails)
      .then(res => {window.localStorage.setItem('token',res.data); setLoading(false);history.push('/home') })
      .catch(e => {console.log(e); setLoading(false); alert('user cannot be added please try again.')})
  }
    ...
    <div  style={{
      ...
      <div className="container" style={{display:'flex',justifyContent:'space-between',marginTop:22,}}>
          <img src={logo} style={{
            ...
            <Link to="/">
                <Button variant="outlined" color="primary" className={classes.main_button}>Login</Button>
            </Link>
      </div>
      <hr/>
      ...
      <div className="container " style={{height:'100vh',marginTop:'4%'}}>
          ...
          <div style={{ width: '100%', height: '70%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <Paper data-aos="zoom-in" elevation={4} style={{ 
                padding: "5% 15%", 
                background:'transparent',
              ...
              <h1 className={classes.form_header} style={{display:'flex', justifyContent:'center'}}>Join Us</h1>
              ...
              <div className={classes.margin}>
                ...
                <div className="d-flex mt-2" style={{ display:'flex', flexWrap:' wrap', justifyContent:'space-around',alignItems:'center'}}>
                 <Button
                ...
                <Link to="/"  className="ml-md-3 ml-0"><strong>*Already have an account.</strong></Link>
              </div>
              </div>
            </Paper>
          </div>
